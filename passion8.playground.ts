/**
 * passion8 中转站 · 1h 提示词缓存注入代理（Deno Deploy Playground 单文件版）
 *
 * 上游：https://passion8.cc/v1  （地址自带 /v1，代理会自动去掉重复的那一层）
 *
...
const DEFAULT_UPSTREAM = "https://passion8.cc/v1";
/** 上游地址是否已经包含 /v1 前缀。passion8 自带 /v1，所以是 true。 */
const UPSTREAM_HAS_V1 = true;
